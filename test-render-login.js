 ...
 * This script:
 * 1. Makes a request to the test-login endpoint on Render
 * 2. Makes a request to the direct-login endpoint on Render
 * 3. Logs the results
 */
...
const apiUrl = 'https://coffee-lab-app.onrender.com/api';

// Test the test-login endpoint
async function testTestLogin() {
  console.log('=== TESTING TEST-LOGIN ENDPOINT ON RENDER ===');
  try {
...
async function testDirectLogin() {
  console.log('\n=== TESTING DIRECT-LOGIN ENDPOINT ON RENDER ===');
  try {
